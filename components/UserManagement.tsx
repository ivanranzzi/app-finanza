...
import { User, UserRole, BackupConfig } from '../types';
import { generateId, STORAGE_KEYS, INITIAL_BACKUP_CONFIG } from '../constants';
import { Trash2, UserPlus, ShieldAlert, User as UserIcon, Edit2, Check, X, Download, Upload, Database, AlertTriangle, FileJson, Calendar, Mail, Clock, History, FileClock } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <div className="bg-purple-50 border border-purple-100 p-4 rounded-lg mb-6">
                ...
                <p className="text-xs text-gray-500 mt-2">
                    * Il sistema richiederà il backup nel giorno e nell'ora stabiliti (o al primo accesso successivo).
                </p>
            </div>
            ...
            <div>
                <h3 className="text-sm font-bold text-gray-700 mb-3 flex items-center gap-2">
                    ...
                    Cronologia Ultimi Backup (Max 5)
                </h3>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1 bg-orange-50 border border-orange-100 rounded-lg p-5 flex flex-col items-start">
                    ...
                    <button onClick={handleBackup} className="mt-auto bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium px-4 py-2 rounded-lg flex items-center gap-2 transition-colors"><Download size={16} /> Scarica Dati</button>
                </div>
                <div className="flex-1 bg-blue-50 border border-blue-100 rounded-lg p-5 flex flex-col items-start">
                    ...
                    <button onClick={handleRestoreClick} className="mt-auto bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-lg flex items-center gap-2 transition-colors"><Upload size={16} /> Carica File</button>
             ...
             <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm p-4">
                 <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
                     ...
                     <div className="p-6 space-y-4">
                         ...
                         <div className="text-sm text-gray-600"><p>Cliccando su "Conferma Ripristino", l'applicazione verrà aggiornata con i dati contenuti nel file selezionato. Tutti i dati non salvati andranno persi.</p></div>
                     </div>
